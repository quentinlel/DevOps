Methode = input ("Que veux-tu faire ? n-Addition n-Soustraction n-Multiplication n-Division n-Arreter n Marque sans faute et 
avec une majuscule ce que tu as choisie ... n= ")
Methode = str (Methode) 
